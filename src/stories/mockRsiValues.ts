...
const fields = [
  {
    ...
    example: "Stephanie",
    validations: [{ rule: "required", errorMessage: "Name is required" }],
    isPrimaryKey: true,
  },
  {
    label: "Surname",
    ...
    fieldType: { type: "input" },
    example: "McDonald",
    validations: [{ rule: "unique", errorMessage: "Last name must be unique", level: "info" }],
  ...
  },
  {
    ...
    fieldType: { type: "input" },
    example: "23",
    validations: [{ rule: "regex", value: "^\\d+$", errorMessage: "Age must be a number", level: "warning" }],
  },
  {
    label: "Team",
    key: "team",
    ...
    example: "Team one",
    validations: [{ rule: "required", errorMessage: "Team is required" }],
  },
  {
    label: "Is manager",
    key: "is_manager",
