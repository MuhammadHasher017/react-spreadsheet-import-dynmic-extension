...
import { StepState, StepType } from "../UploadFlow"
...
export const ValidationStep = <T extends string>({ initialData, file, onNext, onBack }: Props<T>) => {
  ...
  const onContinue = async () => {
    ...
    if (invalidData) {
      ...
      console.log("🚀 ~ All data is valid:", { type: StepType.importMode, mode: "append", data, file })
      onNext?.({ type: StepType.importMode, mode: "append", data, file })
    }
